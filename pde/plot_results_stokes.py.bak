...
uuv = res['uu']
ppv = res['pp']
print 'np.shapes ->', np.shape(xy), np.shape(uuv), np.shape(ppv)
...
# plt.plot(bi_xy[:, 0], bi_xy[:, 1], 'bo-')
# plt.show()

##############################################
# Save image of pressure
#############################################
print('xy = ', xy)
wfig, hfig = 90, 60
fig, ax, cax = leplt.initialize_1panel_cbar_cent(wfig, hfig, wsfrac=0.5, cbar_pos='right', wcbarfrac=0.05, hcbarfrac=0.6)
ax = leplt.plot_pcolormesh(xy[:, 0], xy[:, 1], ppv, 100, ax=ax, cax=cax, zorder=0)
ax.set_title(r'Pressure in Stokes flow, $p$')
ax.yaxis.set_label_position("right")
cax.set_ylabel(r'$p$', rotation=0)
...
ax.xaxis.set_ticks([])
ax.yaxis.set_ticks([])
plt.savefig(outdir + 'stokes_flow_shell' + specstr + '_pressure.png', dpi=300)
...
ax.xaxis.set_ticks([])
ax.yaxis.set_ticks([])
plt.savefig(outdir + 'stokes_flow_shell' + specstr + '_flowfield.png', dpi=300)
...
ax.yaxis.set_label_position("right")
cax.set_ylabel(r'velocity', rotation=90)
plt.savefig(outdir + 'stokes_flow_shell' + specstr + '_flowuv.png', dpi=300)
plt.close('all')
...
ax.set_title(r'Flow speed, $|u|$')
ax.yaxis.set_label_position("right")
cax.set_ylabel(r'$|u|$', rotation=0, labelpad=10)
...
ax.xaxis.set_ticks([])
ax.yaxis.set_ticks([])
plt.savefig(outdir + 'stokes_flow_shell' + specstr + '_speed.png', dpi=300)

# Repeat in log scale
fig, ax, cax = leplt.initialize_1panel_cbar_cent(wfig, hfig, wsfrac=0.5, cbar_pos='right', wcbarfrac=0.05,
                                                 hcbarfrac=0.6)
# print 'log -->', np.log10(speedv)
# plt.close('all')
# plt.plot(np.arange(len(speedv)), np.log10(speedv), 'b.-')
# plt.show()
# sys.exit()
ax = leplt.plot_pcolormesh(xy[:, 0], xy[:, 1], np.log10(speedv), 200, ax=ax, cax=cax, zorder=0)
ax.set_title(r'Flow speed, $|u|$')
ax.yaxis.set_label_position("right")
cax.set_ylabel(r'$\log_{10}|u|$', rotation=90, labelpad=10)
...
ax.xaxis.set_ticks([])
ax.yaxis.set_ticks([])
plt.savefig(outdir + 'stokes_flow_shell' + specstr + '_speedlog.png', dpi=300)
plt.close('all')
...
ax.set_title('Streamlines for stokes flow')
plt.savefig(outdir + 'stokes_flow_shell' + specstr + '_flowuvstreamscaled.png', dpi=300)
...
ax.set_title('Streamlines for stokes flow')
plt.savefig(outdir + 'stokes_flow_shell' + specstr + '_flowuvstream.png', dpi=300)
plt.close('all')
...
plt.savefig(outdir + 'stokes_flow_shell' + specstr + '_flowtop.pdf', dpi=300)
plt.close('all')
