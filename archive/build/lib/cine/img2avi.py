...
if args.smart:
    ...
    frame_slice = slice(*list(map(noneint, args.framelist.split(':'))))
    frames = list(range(*frame_slice.indices(max(kklist.keys()))))
